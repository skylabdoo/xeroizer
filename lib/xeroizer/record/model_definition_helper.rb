  ...
  module Record
    module ModelDefinitionHelper
      ...
      module ClassMethods
        ...
        def string(field_name, options = {}) = define_simple_attribute(field_name, :string, options)
        def boolean(field_name, options = {}) = define_simple_attribute(field_name, :boolean, options)
        def integer(field_name, options = {}) = define_simple_attribute(field_name, :integer, options, 0)
        def decimal(field_name, options = {}) = define_simple_attribute(field_name, :decimal, options, 0.0)
        def date(field_name, options = {}) = define_simple_attribute(field_name, :date, options)
        def datetime(field_name, options = {}) = define_simple_attribute(field_name, :datetime, options)
        def datetime_utc(field_name, options = {}) = define_simple_attribute(field_name, :datetime_utc, options)
