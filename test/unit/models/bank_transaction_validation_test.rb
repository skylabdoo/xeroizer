...
class BankTransactionValidationTest < Minitest::Test
  ...
  must 'supply at least one line item' do
    ...
    assert_empty instance.errors_for(:line_items),
                 "expected no errors for one line item, #{instance.errors_for(:line_items)}"
    ...
    assert_empty instance.errors_for(:line_items),
                 "expected no errors for more than one line item, #{instance.errors_for(:line_items)}"
  end
