...
class ModelDefinitionsTest < Minitest::Test
  ...
  context 'record field definition' do
    ...
    should 'only have proper fields' do
      fieldset = %i[primary_key_id string1 boolean1 integer1 decimal1 date1 datetime1]
      ...
      fieldset = %i[primary_key_id string2 boolean2 integer2 decimal2 date2 datetime2]
      fieldset.each do |field|
